...
urlpatterns = [
    ...
    path(
        "quiz-recommendations/", views.quiz_recommendations, name="quiz_recommendations"
    ),
    path("quiz-create/", views.quiz_create, name="quiz_create"),
    path(
        "quiz-update-skin-type/",
        views.quiz_update_skin_type,
        name="quiz_update_skin_type",
    ),
    path(
        "quiz-update-skin-concern/",
        views.quiz_update_skin_concern,
        name="quiz_update_skin_concern",
    ),
    path(
        "quiz-update-price-range/",
        views.quiz_update_price_range,
        name="quiz_update_price_range",
    ),
